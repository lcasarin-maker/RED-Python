...
script_files = []
exclude_names = {"__init__.py", "core_utils.py", "token_tracker.py", "token_optimizer.py", "auto_audit_loop.py", "chunking_validator.py", "empirical_proof_checker.py", "install_hooks.sh", "rigor_maestro.py", "self_improvement_loop.py", "guardrail_strict.py", "validate_security_tier.py"}
