...
class TestPreEditGuard(unittest.TestCase):
    def test_s6_write_line_limit(self):
        ...
        with patch("scripts.pre_edit_guard._check_compact_sentinel", return_value=None):
            long_content = "line\n" * 205
            violations = evaluate("Write", "test_file.py", long_content)
            self.assertTrue(
                any("S6: Write de" in v for v in violations),
            ...
            self.assertFalse(
                any("S6: Write de" in v for v in violations_edit),
    ...
    def test_s7_shell_mutations(self):
        ...
        self.assertTrue(
            any("S7: Comando shell con escritura detectado" in v for v in violations),
        ...
        self.assertTrue(
            any(
                "S7: Comando shell con escritura detectado" in v for v in violations_pw
            ),
    ...
    def test_s19_zombie_compat_strings(self):
        ...
        self.assertTrue(
            any("shim explícito prohibido" in v for v in violations),
        ...
        self.assertTrue(
            any("ruta alternativa de adopción prohibida" in v for v in violations_fb),
    ...
    def test_deprecated_path_block(self):
        ...
        self.assertTrue(
            any("está en deprecated/ — edición prohibida" in v for v in violations),
