# **Coder Cerberus: Manual Maestro de Control y Supervisión**

Este documento establece el núcleo inmutable del Protocolo Coder Cerberus. Su propósito exclusivo es erradicar el fallo silencioso en el desarrollo asistido por inteligencia artificial mediante una arquitectura defensiva modular y un entorno de auditoría de confianza cero. El sistema opera bajo la premisa de que todo código generado es defectuoso hasta que se demuestre lo contrario mediante validación empírica estricta.

## **1\. Doctrina Operativa y Modelo Mental**
...
Para garantizar el orden y evitar conflictos normativos el flujo de desarrollo se fragmenta de manera estricta en cuatro fases secuenciales independientes.

| Fase Operativa | Mandatos Críticos Activos | Condición de Salida Obligatoria   |
| :---- | :---- | :---- |
| 1\. Startup | Purgar contexto indexar repositorio verificar paridad de versiones core | Validación de integridad de entorno completada |
| 2\. Planning | Análisis del camino hostil diagnóstico de causa raíz estructuración de esquemas | Aprobación humana explícita del archivo de plan físico |
...
El agente operativo mantendrá foco absoluto en la tarea asignada dentro de la fase de ejecución. Los hallazgos secundarios optimizaciones adyacentes o errores menores que no bloqueen el desarrollo actual no detendrán el avance. Estos elementos se documentarán exclusivamente en el historial logístico para su posterior evaluación en una sesión dedicada. La interrupción de la ejecución y el retorno a la fase de planificación solo se autorizan ante bloqueos técnicos reales fallos críticos de seguridad latentes o el agotamiento inminente de los recursos de la sesión.
