...
<!-- Prosa: ningun gate la lee. Migrada de tasks/done/DEBT-ruff-filters-py-47-5-c901-match-rule-is-194f70d6.md el 2026-09-01. -->
...
<!-- findings:start -->
- ruff: filters.py:47:5: C901 `match_rule` is too complex (13 > 10)
<!-- findings:end -->

```json queue-job
{
  "name": "remediate_DEBT-ruff-filters-py-47-5-c901-match-rule-is-194f70d6",
  "command": "ruff check --select C901 filters.py",
  "artifact": "tasks/done/DEBT-ruff-filters-py-47-5-c901-match-rule-is-194f70d6.md"
}
```
...
`match_rule` in `filters.py` grew past ruff's `C901` complexity threshold as branching
...
sub-steps into separate functions, bringing `match_rule` back under the threshold
