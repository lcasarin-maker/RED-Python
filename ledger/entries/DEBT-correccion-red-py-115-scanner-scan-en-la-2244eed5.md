...
<!-- Prosa: ningun gate la lee. Migrada de tasks/done/DEBT-correccion-red-py-115-scanner-scan-en-la-2244eed5.md el 2026-09-01. -->

> **REABIERTA POR EL CONTRATO DE CIERRE, no por un defecto nuevo.** Estaba
> `status: pagada-2026-08-17`. Lo que no trae es `evidence.fail`: la corrida con el
