...
<!-- Prosa: ningun gate la lee. Migrada de tasks/done/DEBT-ruff-app-py-475-9-plr0915-too-many-state-482bb4c6.md el 2026-09-01. -->
...
<!-- findings:start -->
- ruff: app.py:475:9: PLR0915 Too many statements (78 > 50)
<!-- findings:end -->

```json queue-job
{
  "name": "remediate_DEBT-ruff-app-py-475-9-plr0915-too-many-state-482bb4c6",
  "command": "ruff check --select PLR0915 app.py",
  "artifact": "tasks/done/DEBT-ruff-app-py-475-9-plr0915-too-many-state-482bb4c6.md"
}
```
...
`SettingsDialog._build` / `App._build` in `app.py` (originating at app.py:475) had grown
