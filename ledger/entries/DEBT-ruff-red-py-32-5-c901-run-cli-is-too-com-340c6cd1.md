...
<!-- Prosa: ningun gate la lee. Migrada de tasks/done/DEBT-ruff-red-py-32-5-c901-run-cli-is-too-com-340c6cd1.md el 2026-09-01. -->
...
<!-- findings:start -->
- ruff: red.py:32:5: C901 `_run_cli` is too complex (18 > 10)
<!-- findings:end -->

```json queue-job
{
  "name": "remediate_DEBT-ruff-red-py-32-5-c901-run-cli-is-too-com-340c6cd1",
  "command": "ruff check --select C901 red.py",
  "artifact": "tasks/done/DEBT-ruff-red-py-32-5-c901-run-cli-is-too-com-340c6cd1.md"
}
```
...
`_run_cli` in `red.py` grew past ruff's `C901` complexity threshold as branching
...
`ruff check --select C901 red.py` is the regression test: it fails again the
