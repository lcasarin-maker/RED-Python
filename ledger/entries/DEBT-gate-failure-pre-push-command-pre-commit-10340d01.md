...
close_check: {"cmd": "python3 -m pre_commit run --config .pre-commit-config.yaml --all-files", "expect": "exit_zero"}
created: 2026-08-28
---

<!-- Prosa: ningun gate la lee. Migrada de tasks/done/DEBT-gate-failure-pre-push-command-pre-commit-10340d01.md el 2026-09-01. -->
