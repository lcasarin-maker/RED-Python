...
<!-- Prosa: ningun gate la lee. Migrada de tasks/done/DEBT-ruff-core-py-93-9-plr0912-too-many-branc-4673d9af.md el 2026-09-01. -->
...
<!-- findings:start -->
- ruff: core.py:93:9: PLR0912 Too many branches (14 > 12)
<!-- findings:end -->

```json queue-job
{
  "name": "remediate_DEBT-ruff-core-py-93-9-plr0912-too-many-branc-4673d9af",
  "command": "ruff check --select PLR0912 core.py",
  "artifact": "tasks/done/DEBT-ruff-core-py-93-9-plr0912-too-many-branc-4673d9af.md"
}
```
...
`_scan_root` in `core.py` grew past ruff's `PLR0912` complexity threshold as branching
...
`ruff check --select PLR0912 core.py` is the regression test: it fails again the
...
```
$ ruff check --select PLR0912 core.py
All checks passed!
```
