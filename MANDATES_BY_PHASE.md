# 📋 MANDATES BY PHASE — VibeCoderProof v5.7.1
...
| **S17** | Paridad Versión | Validar `.version` en todos los archivos core = v5.7.1 |
...
- [ ] SPEC.md version == v5.7.1
- [ ] AGENT.md version == v5.7.1
- [ ] .agent_state.json version == v5.7.1
- [ ] PROTOCOL_*.md version == v5.7.1
