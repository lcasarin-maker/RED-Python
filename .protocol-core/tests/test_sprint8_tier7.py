...
class TestProtocolClient:
    ...
    def test_run_maintenance_invokes_explicit_post_commit_steps(self, monkeypatch, tmp_path):
        from scripts import protocol_cli as pcli
    ...
    def test_post_commit_hook_is_opt_in(self):
        content = (PROJECT_ROOT / "scripts" / "hooks" / "post-commit").read_text(encoding="utf-8")
