...
_logger = logging.getLogger("core_utils")

# SESSION token budget (TK-041): max tokens allowed for the active working session.
# NOTE: This is NOT the context window (200K total) nor the file-size proxy used
#       by protocol_cli._calculate_compact_threshold() (100_000 bytes).
