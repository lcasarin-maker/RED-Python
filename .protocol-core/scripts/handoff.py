...
def main() -> None:
    ...
    """
    parser = argparse.ArgumentParser(description="Automatiza la creación de un paquete de Handoff entre agentes.")
    parser.add_argument("--archivo", "-a", type=str, help="Ruta del archivo relevante para el handoff.")
    parser.add_argument("--lineas", "-l", type=str, help="Rango de líneas (ej. 110-160).")
    parser.add_argument("--comando", "-c", type=str, help="Comando exacto de validación (ej. pytest).", default="")
    parser.add_argument("--clipboard", action="store_true", help="Copia el resultado al portapapeles (requiere pyperclip).")
...
"""
    ...
    if args.clipboard:
        try:
            ...
            print("⚠️ El módulo 'pyperclip' no está instalado. Ejecuta: pip install pyperclip")
